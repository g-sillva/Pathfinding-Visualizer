...
export const visualizeBreadthFirstSearch = (grid, start_node_row, start_node_col, finish_node_row, finish_node_col) => {
...
const animateBreadthFirstSearch = (visitedNodesInOrder, nodesInShortestPathOrder) => {
